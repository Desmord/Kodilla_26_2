...
const maleNames = [`Mikołaj`, `Paweł`, `Kamil`, `Michał`, `Marcin`, `Mateusz`, `Tomasz`];
const femaleNames = [`Ala`, `Dorota`, `Ania`, `Monika`, `Marta`, `Natalia`, `Aleksandra`, `małgorzata`];
const lastNames = [`Ogórek`, `Marchewka`, `Poziomka`, `Burak`, `Ziemniak`, `Seler`, `Wiśnia`];
